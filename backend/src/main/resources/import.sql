...
insert into restaurant (id, name, shipping_fee, cuisine_id ) values (2, 'Thai Delivery', 9.50, 1);
insert into restaurant (id, name, shipping_fee, cuisine_id ) values (3, 'Tuk Tuk Comida Indiana', 15, 2);
insert into restaurant (id, name, shipping_fee, cuisine_id ) values (4, 'Java Steakhouse', 12, 3);
insert into restaurant (id, name, shipping_fee, cuisine_id ) values (5, 'Lanchonete do Tio Sam', 11, 4);
insert into restaurant (id, name, shipping_fee, cuisine_id ) values (6, 'Bar da Maria', 6, 4);
